CREATE TABLE course (course_id int NOT NULL IDENTITY(1,1) ,course_name varchar(100) NOT NULL,dept_id int NOT NULL,sem_no int NOT NULL) 
CREATE TABLE department  (dept_id  int NOT NULL IDENTITY(1,1),dept_name  varchar(100) NOT NULL,inst_id  int NOT NULL)
CREATE TABLE exam  (exam_id  int NOT NULL IDENTITY(1,1),exam_name  varchar(100) NOT NULL,description  varchar(300) NOT NULL,subject_id  int NOT NULL,quiz_id  int NOT NULL,subjective_id  int NOT NULL,starting_date  datetime NOT NULL,ending_date  datetime NOT NULL,duration  int NOT NULL,teacher_id  int NOT NULL)
...
CREATE TABLE feeback (feedback_id  int NOT NULL IDENTITY(1,1),user_id  int NOT NULL,feedback  int NOT NULL) 
CREATE TABLE  institution  (inst_id  int NOT NULL IDENTITY(1,1),inst_name  varchar(150) NOT NULL,inst_email  varchar(50) NOT NULL,inst_address  varchar(250) NOT NULL,inst_phno  int NOT NULL)
CREATE TABLE  quiz  (quiz_id  int NOT NULL IDENTITY(1,1),exam_id  int NOT NULL,description  varchar(250) NOT NULL,mark  int NOT NULL,qno_of_questions  int NOT NULL)
CREATE TABLE  quiz_questions  (quiz_id  int NOT NULL,question_id int NOT NULL IDENTITY(1,1),question_title  varchar(500) NOT NULL,option1  varchar(300) NOT NULL,option2  varchar(300) NOT NULL,option3  varchar(300) NOT NULL,option4  varchar(300) NOT NULL,answer  int NOT NULL)
...
CREATE TABLE  subject  (subject_id  int NOT NULL IDENTITY(1,1),subject_name  varchar(100) NOT NULL,course_id  int NOT NULL,course_sem  int NOT NULL)
CREATE TABLE  subjective  (subjective_id  int NOT NULL IDENTITY(1,1),exam_id  int NOT NULL,description  varchar(250) NOT NULL,sno_of_questions  int NOT NULL)
...
CREATE TABLE  subjective_questions  (subjective_id  int NOT NULL,question_id int NOT NULL IDENTITY(1,1),question_title  varchar(300) NOT NULL,mark  int NOT NULL)
